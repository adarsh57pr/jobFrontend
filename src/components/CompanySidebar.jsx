...
const CompanySidebar = () => {
    ...
    return (
        <div>
            ...
            <div className='fixed h-full  left-0 top-[63px] w-max p-4 bg-gray-900 text-white'>
                ...
                {showMobileBar && <div className=' sm:block  left-0  text-white'>
                    ...
                    <ul>
                        ...
                        <li className='border-b-2 border-white p-3'><Link>Applied Jobs</Link></li>
                    </ul>
                </div>}
                <div className=' sm:block hidden    text-white'>
                    <ul>
                        <li className='bg-teal-800 rounded-sm px-4 py-2 hover:bg-teal-700 text-white'><Link to="/companyDashboard/createJob">Create Job</Link></li>
                        <li className='border-b-2 border-white p-3 hover:scale-75'><Link to="/ourCompanyJobs">Show All Jobs</Link></li>
                        <li className='border-b-2 border-white p-3 hover:scale-75'><Link>Applied Jobs</Link></li>
                    </ul>

                </div>
            </div>

            {/* <nav className="bg-[#09090a] shadow-lg h-[90vh] fixed top-[65px] left-0 min-w-[260px] py-6 px-6 font-[sans-serif] flex flex-col overflow-auto">
                <div className="flex flex-wrap items-center cursor-pointer">
                    <div className="relative">
                        ...
                        <span className="h-3 w-3 rounded-full bg-green-600 border-2 border-white block absolute bottom-0 right-0" />
                    </div>
                    <div className="ml-4">
                ...
                <div className="relative bg-[#1f1f22] px-4 py-3 rounded-md my-8">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 mr-3 inline fill-gray-300" viewBox="0 0 118.783 118.783">
                        <path d="M115.97 101.597 88.661 74.286a47.75 47.75 0 0 0 7.333-25.488c0-26.509-21.49-47.996-47.998-47.996S0 22.289 0 48.798c0 26.51 21.487 47.995 47.996 47.995a47.776 47.776 0 0 0 27.414-8.605l26.984 26.986a9.574 9.574 0 0 0 6.788 2.806 9.58 9.58 0 0 0 6.791-2.806 9.602 9.602 0 0 0-.003-13.577zM47.996 81.243c-17.917 0-32.443-14.525-32.443-32.443s14.526-32.444 32.443-32.444c17.918 0 32.443 14.526 32.443 32.444S65.914 81.243 47.996 81.243z" data-original="#000000" />
                    </svg>
                    <input className="text-sm text-gray-300 outline-none bg-transparent px-1 max-w-[130px]" placeholder="Search..." />
                </div>
                <ul className="space-y-10 flex-1 mt-4 mb-10">
                    ...
                    <li>
                        <a href="javascript:void(0)" className="text-gray-300 hover:text-white text-sm flex items-center rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke="currentColor" className="w-[18px] h-[18px] mr-4" viewBox="0 0 682.667 682.667">
                                <defs>
